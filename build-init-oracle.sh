...
sudo docker run -d --hostname $IS_HOST_NAME --name $DOCKER_CONTAINER_NAME --restart=always -p 4000:4000 -p $IS_HOST_PORT:9443  $CARBON_UI_CUSTOM_IS_BRANCH/$PROCUCT_NAME:o$PROCUCT_VERSION
